...
const STRINGS = {
  ...
  'nav.lostfound': { mr: 'हरवले-सापडले', en: 'Lost & found' },
  'nav.assistance': { mr: 'मदत विनंत्या', en: 'Assistance' },
  'nav.heritage': { mr: 'वारसा', en: 'Heritage' },

  // Heritage moderation (Track 1, item 5)
  'her.title': { mr: 'वारसा नोंदी तपासा', en: 'Heritage contributions' },
  'her.empty': { mr: 'तपासण्यासाठी काहीही नाही.', en: 'Nothing waiting to be checked.' },
  'her.publish': { mr: 'संग्रहात घ्या', en: 'Publish' },
  'her.decline': { mr: 'नाकारा', en: 'Decline' },
  'her.whyDecline': { mr: 'कारण', en: 'Reason' },
  'her.confirmDecline': { mr: 'नाकारल्याची नोंद करा', en: 'Record the decline' },
  'her.kind.abhang': { mr: 'अभंग', en: 'Abhang' },
  'her.kind.ovi': { mr: 'ओवी', en: 'Ovi' },
  'her.kind.bhajan': { mr: 'भजन', en: 'Bhajan' },
  'her.kind.kirtan': { mr: 'कीर्तन', en: 'Kirtan' },
  'her.kind.story': { mr: 'आठवण', en: 'Memory' },
  'her.kind.ritual': { mr: 'प्रथा', en: 'Custom' },
  'her.kind.place_lore': { mr: 'स्थलकथा', en: 'Place lore' },
  'her.kind.dindi_history': { mr: 'दिंडीचा इतिहास', en: 'Dindi history' },
  'her.kind.photo': { mr: 'छायाचित्र', en: 'Photograph' },

  // Assistance board (Track 1, item 4)
  'assist.title': { mr: 'मदत विनंत्या', en: 'Assistance requests' },
  'assist.empty': { mr: 'कोणतीही विनंती प्रलंबित नाही.', en: 'Nothing waiting.' },
  'assist.late': { mr: 'उशिरा', en: 'overdue' },
  'assist.noZone': { mr: 'विभाग अज्ञात', en: 'zone unknown' },
  'assist.claim': { mr: 'मी जातो', en: 'I will go' },
  'assist.met': { mr: 'मदत पोहोचली', en: 'Help delivered' },
  'assist.unmet': { mr: 'मदत पोहोचली नाही', en: 'Nobody came' },
  'assist.whyUnmet': { mr: 'का पोहोचली नाही', en: 'Why not' },
  'assist.confirmUnmet': { mr: 'नोंदवा', en: 'Record it' },
  'assist.need.wheelchair': { mr: 'चाकाची खुर्ची', en: 'Wheelchair' },
  'assist.need.walking_support': { mr: 'चालण्यास आधार', en: 'Walking support' },
  'assist.need.stretcher': { mr: 'स्ट्रेचर', en: 'Stretcher' },
  'assist.need.vision': { mr: 'दृष्टी', en: 'Vision' },
  'assist.need.hearing': { mr: 'श्रवण', en: 'Hearing' },
  'assist.need.speech': { mr: 'वाचा', en: 'Speech' },
  'assist.need.cognitive': { mr: 'सोपे मार्गदर्शन', en: 'Simple guidance' },
  'assist.need.companion_required': { mr: 'सोबती आवश्यक', en: 'Companion required' },
  'assist.need.step_free_route': { mr: 'पायऱ्या नसलेला मार्ग', en: 'Step-free route' },
  'assist.need.oxygen': { mr: 'ऑक्सिजन', en: 'Oxygen' },

  // Lost and found desk (Track 1, item 2)
  'lf.title': { mr: 'हरवले-सापडले कक्ष', en: 'Lost & found desk' },
  'lf.lostColumn': { mr: 'हरवल्याच्या नोंदी', en: 'Reported lost' },
  'lf.foundColumn': { mr: 'जमा झालेल्या वस्तू', en: 'Handed in' },
  'lf.empty': { mr: 'काहीही प्रलंबित नाही.', en: 'Nothing waiting.' },
  'lf.hasSuggestions': { mr: 'जुळणी सुचवली', en: 'match suggested' },
  'lf.suggestions': { mr: 'संभाव्य जुळण्या', en: 'Possible matches' },
  'lf.strong': { mr: 'ठळक जुळणी', en: 'strong' },
  'lf.accept': { mr: 'जुळणी स्वीकारा', en: 'Accept match' },
  'lf.reject': { mr: 'नाकारा', en: 'Reject' },
  'lf.mark': { mr: 'ओळखीची खूण', en: 'Identifying mark' },
  'lf.handover': { mr: 'वस्तू सुपूर्द करा', en: 'Hand the item over' },
  'lf.claimant': { mr: 'घेणाऱ्याचे नाव', en: 'Claimant name' },
  'lf.handoverNote': { mr: 'ओळख कशी पटली', en: 'How they proved it' },
  'lf.confirmHandover': { mr: 'सुपूर्द केले', en: 'Confirm handover' },
  'lf.reasonSameZone': { mr: 'तोच विभाग', en: 'same zone' },
  'lf.reasonOtherZone': { mr: 'वेगळा विभाग', en: 'different zone' },
  'lf.reasonHours': { mr: ' तासांचे अंतर', en: 'h apart' },
  ...
  'lf.cat.walking_aid': { mr: 'काठी / चाकाची खुर्ची', en: 'Walking aid' },
